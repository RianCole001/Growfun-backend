# Minimal working settings for local development and debugging
import os
...
# Security
SECRET_KEY = config('SECRET_KEY', default='django-insecure-minimal-key-for-testing-only')
...
# CORS Settings - ALLOW ALL FOR LOCAL TESTING
